...
static struct dsi_cmd_desc k2_auo_display_on_cmds[] = {
	...
	{DTYPE_PERIPHERAL_ON, 1, 0, 1, 120, sizeof(k2_peripheral_on), 
k2_peripheral_on},
};

static struct dsi_cmd_desc k2_auo_display_off_cmds[] = {
	{DTYPE_PERIPHERAL_OFF, 1, 0, 1, 70, sizeof(k2_peripheral_off), 
k2_peripheral_off},
};
...
#ifdef EVA_CMD_MODE_PANEL
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(display_mode_cmd), 
display_mode_cmd},
#else
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(display_mode_video), 
display_mode_video},
#endif
