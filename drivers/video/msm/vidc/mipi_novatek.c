...
struct dcs_cmd_req cmdreq_novatek;
...
static void mipi_novatek_set_backlight(struct msm_fb_data_type *mfd)
{
	...
	cmdreq_novatek.cmds = &backlight_cmd;
	cmdreq_novatek.cmds_cnt = 1;
	cmdreq_novatek.flags = 0;
	cmdreq_novatek.rlen = 0;
	cmdreq_novatek.cb = NULL;

	mipi_dsi_cmdlist_put(&cmdreq_novatek);
}
